...
public class Permission$Builder {
    ...
    public Permission build() {
        Permission permission = new Permission(this.role, this.canRead, this.canUpdate, this.canDelete, this.canSetPermissions, this.canQuery, this.canCreate, this.canModifySchema, null);
        return permission;
    }
}
