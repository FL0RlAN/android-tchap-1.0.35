...
class BaseModuleMediator extends RealmProxyMediator {
    ...
    public <E extends RealmModel> E copyOrUpdate(Realm realm, E e, boolean z, Map<RealmModel, RealmObjectProxy> map, Set<ImportFlag> set) {
        ...
        if (superclass.equals(PermissionUser.class)) {
            return (RealmModel) superclass.cast(io_realm_sync_permissions_PermissionUserRealmProxy.copyOrUpdate(realm, (io_realm_sync_permissions_PermissionUserRealmProxy$PermissionUserColumnInfo) realm.getSchema().getColumnInfo(PermissionUser.class), (PermissionUser) e, z, map, set));
        } else if (superclass.equals(RealmPermissions.class)) {
            return (RealmModel) superclass.cast(io_realm_sync_permissions_RealmPermissionsRealmProxy.copyOrUpdate(realm, (io_realm_sync_permissions_RealmPermissionsRealmProxy$RealmPermissionsColumnInfo) realm.getSchema().getColumnInfo(RealmPermissions.class), (RealmPermissions) e, z, map, set));
        } else if (superclass.equals(ClassPermissions.class)) {
            return (RealmModel) superclass.cast(io_realm_sync_permissions_ClassPermissionsRealmProxy.copyOrUpdate(realm, (io_realm_sync_permissions_ClassPermissionsRealmProxy$ClassPermissionsColumnInfo) realm.getSchema().getColumnInfo(ClassPermissions.class), (ClassPermissions) e, z, map, set));
        } else if (superclass.equals(Permission.class)) {
            return (RealmModel) superclass.cast(io_realm_sync_permissions_PermissionRealmProxy.copyOrUpdate(realm, (io_realm_sync_permissions_PermissionRealmProxy$PermissionColumnInfo) realm.getSchema().getColumnInfo(Permission.class), (Permission) e, z, map, set));
        } else if (superclass.equals(Role.class)) {
            return (RealmModel) superclass.cast(io_realm_sync_permissions_RoleRealmProxy.copyOrUpdate(realm, (io_realm_sync_permissions_RoleRealmProxy$RoleColumnInfo) realm.getSchema().getColumnInfo(Role.class), (Role) e, z, map, set));
        } else if (superclass.equals(Subscription.class)) {
            return (RealmModel) superclass.cast(io_realm_sync_SubscriptionRealmProxy.copyOrUpdate(realm, (io_realm_sync_SubscriptionRealmProxy$SubscriptionColumnInfo) realm.getSchema().getColumnInfo(Subscription.class), (Subscription) e, z, map, set));
        } else {
