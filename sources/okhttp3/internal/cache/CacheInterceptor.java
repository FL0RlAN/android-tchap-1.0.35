...
public final class CacheInterceptor implements Interceptor {
    ...
    private Response cacheWritingResponse(final CacheRequest cacheRequest, Response response) throws IOException {
        ...
        return response.newBuilder().body(new RealResponseBody(response.header(com.facebook.stetho.server.http.HttpHeaders.CONTENT_TYPE), response.body().contentLength(), Okio.buffer((Source) r2))).build();
    }
