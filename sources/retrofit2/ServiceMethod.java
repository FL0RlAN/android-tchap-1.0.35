        ...
        private ParameterHandler<?> parseParameterAnnotation(int i, Type type, Annotation[] annotationArr, Annotation annotation) {
            ...
            if (annotation instanceof Url) {
                if (this.gotUrl) {
                    ...
                    throw parameterError(i, str, new Object[0]);
                ...
                if (annotation instanceof Query) {
                    ...
                    if (annotation instanceof QueryMap) {
                        ...
                        if (Map.class.isAssignableFrom(rawType3)) {
                            ...
                            throw parameterError(i, str4, new Object[0]);
                        }
                            ...
                            if (value4.isEmpty()) {
                                ...
                                if (Iterable.class.isAssignableFrom(rawType8)) {
                                    if (!(type instanceof ParameterizedType)) {
                                        ...
                                        throw parameterError(i, str5, new Object[0]);
                                    }
                                ...
                                if (Iterable.class.isAssignableFrom(rawType8)) {
                                    if (type instanceof ParameterizedType) {
                                        ...
                                        throw parameterError(i, str6, new Object[0]);
                                    }
