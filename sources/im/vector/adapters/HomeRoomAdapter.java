...
public class HomeRoomAdapter extends AbsFilterableAdapter<RoomViewHolder> {
    ...
    public HomeRoomAdapter(Context context, int i, OnSelectRoomListener onSelectRoomListener, RoomInvitationListener roomInvitationListener, MoreRoomActionListener moreRoomActionListener) {
    ...
    public void filterRooms(CharSequence charSequence) {
        ...
        this.mFilteredRooms.addAll(RoomUtils.getFilteredRooms(this.mContext, this.mRooms, charSequence));
    }
}
