...
public class RoomDirectoryAdapter extends Adapter<RoomDirectoryViewHolder> {
    ...
    public static final String LOG_TAG = RoomDirectoryAdapter.class.getSimpleName();
    /* access modifiers changed from: private */
    ...
    class RoomDirectoryViewHolder extends ViewHolder {
        ...
        public void populateViews(final RoomDirectoryData roomDirectoryData) {
            ...
            if (roomDirectoryData.isIncludedAllNetworks()) {
                charSequence = this.vServerTextView.getContext().getString(R.string.directory_server_all_rooms_on_server, new Object[]{roomDirectoryData.getDisplayName()});
            } else {
                if (TextUtils.equals("Matrix", roomDirectoryData.getDisplayName())) {
                    charSequence = this.vServerTextView.getContext().getString(R.string.directory_server_native_rooms, new Object[]{roomDirectoryData.getDisplayName()});
                } else {
                    charSequence = null;
                }
            }
            ...
            if (!roomDirectoryData.isIncludedAllNetworks()) {
                drawable = this.vServerTextView.getContext().getResources().getDrawable(R.drawable.network_matrix);
            }
    ...
    private void downloadAvatar(final ImageView imageView, final String str) {
        if (!(imageView == null || str == null)) {
            ...
            AnonymousClass1 r0 = new AsyncTask<Void, Void, Bitmap>() {
