...
public class AdapterSection<T> {
    ...
    public void updateTitle() {
        String str;
        if (getNbItems() <= 0 || this.mTitle.length() <= 0) {
            str = this.mTitle;
        } else {
    ...
    public void formatTitle(String str) {
        ...
        spannableString.setSpan(new ForegroundColorSpan(ThemeUtils.INSTANCE.getColor(this.mContext, R.attr.vctr_list_header_subtext_color)), this.mTitle.length(), str.length(), 0);
