...
final class FileUtilsKt$lsFiles$2 extends FunctionReference implements Function1<File, Boolean> {
    public static final FileUtilsKt$lsFiles$2 INSTANCE = new FileUtilsKt$lsFiles$2();

    FileUtilsKt$lsFiles$2() {
        super(1);
    }
