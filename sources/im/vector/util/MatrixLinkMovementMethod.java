        ...
        if (clickableSpanArr.length != 0) {
            if (action == 1) {
                if (clickableSpanArr[0] instanceof URLSpan) {
                    IMessagesAdapterActionsListener iMessagesAdapterActionsListener = this.mListener;
                    if (iMessagesAdapterActionsListener != null) {
                        iMessagesAdapterActionsListener.onURLClick(Uri.parse(((URLSpan) clickableSpanArr[0]).getURL()));
                    }
                } else {
