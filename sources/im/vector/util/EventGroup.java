...
public class EventGroup extends Event {
    ...
    public static boolean isSupported(MessageRow messageRow) {
        return messageRow != null && messageRow.getEvent() != null && TextUtils.equals(messageRow.getEvent().getType(), "m.room.member") && !TextUtils.equals(messageRow.getEvent().stateKey, MXCallsManager.getConferenceUserId(messageRow.getEvent().roomId));
    }
    ...
    public String toString(Context context) {
        return context.getResources().getQuantityString(R.plurals.membership_changes, this.mRowsMap.size(), new Object[]{Integer.valueOf(this.mRowsMap.size())});
    }
}
