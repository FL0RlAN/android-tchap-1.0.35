...
public class VideoRecordProgressView extends View {
    ...
    private final Runnable mProgressHandler = new Runnable() {
        public void run() {
            ...
            videoRecordProgressView.mAngle = videoRecordProgressView.mAngle + 12;
    ...
    public void refreshColor() {
        ...
        int i2 = (i - 1) % 2;
        int color = getResources().getColor(R.color.vector_silver_color);
    ...
    public void onDraw(Canvas canvas) {
        ...
        int i = this.mAngle;
        canvas2.drawArc(rectF, (float) (i + START_ANGLE), (float) (360 - i), true, this.mPaint);
    }
}
