...
class Chain {
    ...
    static void applyChainConstraints(ConstraintWidgetContainer constraintWidgetContainer, LinearSystem linearSystem, int i, int i2, ChainHead chainHead) {
        ...
        while (true) {
            ...
            if (z5) {
                if (constraintWidget13.getVisibility() == 8 || constraintWidget13.mListDimensionBehaviors[i] != DimensionBehaviour.MATCH_CONSTRAINT) {
                    i7 = 0;
                } else {
                    i7 = 0;
        ...
        if (constraintWidget9 != null) {
            ...
            if (constraintWidget7.mListAnchors[i10].mTarget != null) {
                ...
                linearSystem2.addLowerThan(constraintAnchor8.mSolverVariable, constraintWidget7.mListAnchors[i10].mTarget.mSolverVariable, -constraintAnchor8.getMargin(), 5);
                if (z5) {
                    int i11 = i2 + 1;
                    linearSystem2.addGreaterThan(constraintWidgetContainer2.mListAnchors[i11].mSolverVariable, constraintWidget7.mListAnchors[i11].mSolverVariable, constraintWidget7.mListAnchors[i11].getMargin(), 6);
                }
