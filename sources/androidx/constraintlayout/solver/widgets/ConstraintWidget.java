...
public class ConstraintWidget {
    ...
    private void applyConstraints(LinearSystem linearSystem, boolean z, SolverVariable solverVariable, SolverVariable solverVariable2, DimensionBehaviour dimensionBehaviour, boolean z2, ConstraintAnchor constraintAnchor, ConstraintAnchor constraintAnchor2, int i, int i2, int i3, int i4, float f, boolean z3, boolean z4, int i5, int i6, int i7, float f2, boolean z5) {
        ...
        boolean z15 = (i29 == 1 || i29 == 2 || i29 == 3 || i29 != 4 || i28 == 4) ? false : true;
        if (this.mVisibility == 8) {
            i8 = 0;
            z6 = false;
        } else {
        ...
        if (z5) {
            if (!isConnected && !isConnected2 && !isConnected3) {
                ...
                if (z6) {
                    ...
                    if (i21 > 0) {
                        linearSystem2.addGreaterThan(createObjectVariable2, createObjectVariable, i21, 6);
                        i8 = Math.max(i8, i21);
                    }
                    if (i11 > 0) {
                            ...
                            if (isConnected && isConnected2) {
                                if (z6) {
                                    ...
                                    if (i10 == 0) {
                                        ...
                                        linearSystem2.addEquality(createObjectVariable, solverVariable6, constraintAnchor.getMargin(), i20);
                                        linearSystem2.addEquality(createObjectVariable2, solverVariable18, -constraintAnchor2.getMargin(), i20);
                                        z8 = i11 > 0 || i12 > 0;
                                        z7 = z12;
                                        i17 = 5;
                                    } else {
                                        ...
                                        if (i32 == 1) {
                                            ...
                                            if (z8) {
                                                ...
                                                linearSystem.addCentering(createObjectVariable, solverVariable6, constraintAnchor.getMargin(), f, solverVariable18, createObjectVariable2, constraintAnchor2.getMargin(), i17);
                                                ...
                                                if (z16 && !z17) {
                                                    ...
                                                    linearSystem2.addLowerThan(solverVariable8, solverVariable7, -constraintAnchor2.getMargin(), i18);
                                                    if (z) {
                                                    }
                                                } else if (!z16 && z17) {
                                                    z10 = z;
        ...
        linearSystem2.addGreaterThan(createObjectVariable, solverVariable162, 0, 6);
        linearSystem2.addGreaterThan(solverVariable172, solverVariable152, 0, 6);
    }
