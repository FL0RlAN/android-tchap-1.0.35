            ...
            if (z4) {
                ...
                while (constraintWidget12 != null) {
                    ...
                    if (constraintWidget13 != null || constraintWidget12 == constraintWidget3) {
                        ...
                        float f9 = margin + f8;
                        constraintWidget12.mListAnchors[i9].getResolutionNode().resolve(resolutionNode.resolvedTarget, f9);
                        ...
                        biasPercent = f9 + ((float) constraintWidget12.mListAnchors[i9].getMargin());
                    }
                ...
                if (z2 || z) {
                    ...
                    float f10 = f7 / ((float) (i8 + 1));
                    if (z) {
                        f10 = f7 / (i8 > 1 ? (float) (i8 - 1) : 2.0f);
                    }
                    float f11 = constraintWidget14.getVisibility() != 8 ? f5 + f10 : f5;
                    if (z && i8 > 1) {
                        f11 = ((float) constraintWidget4.mListAnchors[i2].getMargin()) + f5;
                    }
                    ...
                    while (constraintWidget14 != null) {
                        ...
                        if (constraintWidget15 != null || constraintWidget14 == constraintWidget3) {
                            ...
                            if (constraintWidget14 != constraintWidget4) {
                                f11 += (float) constraintWidget14.mListAnchors[i2].getMargin();
                            }
                            constraintWidget14.mListAnchors[i2].getResolutionNode().resolve(resolutionNode.resolvedTarget, f11);
                            constraintWidget14.mListAnchors[i9].getResolutionNode().resolve(resolutionNode.resolvedTarget, f11 + f12);
                            ...
                            f11 += f12 + ((float) constraintWidget14.mListAnchors[i9].getMargin());
                ...
                if (constraintWidget17 != null || constraintWidget16 == constraintWidget3) {
                    ...
                    if (f2 > 0.0f) {
                        if (constraintWidget16.mWeight[i6] == -1.0f) {
                            ...
                            f14 = (constraintWidget16.mWeight[i6] * f13) / f2;
                        }
                    }
                    ...
                    constraintWidget16.mListAnchors[i9].getResolutionNode().resolve(resolutionNode.resolvedTarget, f15);
                    ...
                    f5 = f15 + ((float) constraintWidget16.mListAnchors[i9].getMargin());
                }
