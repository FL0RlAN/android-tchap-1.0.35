        ...
        if (mode == Integer.MIN_VALUE) {
            ...
            if (!(typedValue2 == null || typedValue2.type == 0)) {
                if (typedValue2.type == 5) {
                    ...
                    i6 = 0;
                    if (i6 > 0) {
                        i3 = MeasureSpec.makeMeasureSpec(Math.min(i6 - (this.mDecorPadding.left + this.mDecorPadding.right), MeasureSpec.getSize(i)), 1073741824);
                        z = true;
                        if (mode2 == Integer.MIN_VALUE) {
                            ...
                            if (!(typedValue3 == null || typedValue3.type == 0)) {
                                if (typedValue3.type == 5) {
                                    ...
                                    i5 = 0;
                                    if (i5 > 0) {
                                        i2 = MeasureSpec.makeMeasureSpec(Math.min(i5 - (this.mDecorPadding.top + this.mDecorPadding.bottom), MeasureSpec.getSize(i2)), 1073741824);
                                    }
                                }
                                i5 = (int) fraction2;
                                if (i5 > 0) {
