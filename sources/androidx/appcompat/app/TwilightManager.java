...
class TwilightManager {
    ...
    private void updateState(Location location) {
        ...
        twilightCalculator.calculateTwilight(currentTimeMillis - AdapterUtils.MS_IN_DAY, location.getLatitude(), location.getLongitude());
        ...
        long j6 = j3;
        boolean z2 = z;
        instance.calculateTwilight(AdapterUtils.MS_IN_DAY + currentTimeMillis, location.getLatitude(), location.getLongitude());
