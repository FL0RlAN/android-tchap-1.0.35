        ...
        private void createListView(final AlertController alertController) {
            ...
            if (this.mIsMultiChoice) {
                ...
                if (cursor == null) {
                    ...
                    ? r12 = new CursorAdapter(this.mContext, cursor, false) {
                ...
                if (cursor2 != null) {
                    ? simpleCursorAdapter = new SimpleCursorAdapter(this.mContext, i2, cursor2, new String[]{this.mLabelColumn}, new int[]{16908308});
