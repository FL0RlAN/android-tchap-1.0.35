  ...
  mth insns count: 435
    ...
    public void moveToState(Fragment fragment, int i, int i2, int i3, boolean z) {
        ...
        if (fragment2.mRemoving && i4 > fragment2.mState) {
            if (fragment2.mState != 0 || !fragment.isInBackStack()) {
                i4 = fragment2.mState;
            } else {
                i4 = 1;
            }
        }
        ? r11 = (!fragment2.mDeferStart || fragment2.mState >= 3 || i4 <= 2) ? i4 : 2;
                    ...
                    if (!fragment2.mFromLayout) {
                        if (fragment2.mContainerId != 0) {
                            ...
                            if (viewGroup == null && !fragment2.mRestored) {
                                ...
                                sb8.append(Integer.toHexString(fragment2.mContainerId));
                                sb8.append(" (");
                                sb8.append(str);
