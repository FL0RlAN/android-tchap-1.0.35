...
public class StaggeredGridLayoutManager extends LayoutManager implements ScrollVectorProvider {
    ...
    private void updateLayoutState(int i, State state) {
        ...
        LayoutState layoutState222 = this.mLayoutState;
        layoutState222.mStopInFocusable = false;
        layoutState222.mRecycle = true;
        z = true;
        layoutState222.mInfinite = z;
    }
        ...
        while (layoutState.hasMore(state) && (this.mLayoutState.mInfinite || !this.mRemainingSpans.isEmpty())) {
            ...
            if (layoutState2.mLayoutDirection == 1) {
                ...
                if (z3 && layoutParams.mFullSpan) {
                    FullSpanItem createFullSpanItemFromEnd = createFullSpanItemFromEnd(i11);
                ...
                if (z3 && layoutParams.mFullSpan) {
                    FullSpanItem createFullSpanItemFromStart = createFullSpanItemFromStart(i10);
