...
public class FirebaseMessaging {
    ...
    public static synchronized FirebaseMessaging getInstance() {
        ...
        synchronized (FirebaseMessaging.class) {
            if (zzds == null) {
                zzds = new FirebaseMessaging(FirebaseInstanceId.getInstance());
            }
            firebaseMessaging = zzds;
        }
    ...
    public void send(RemoteMessage remoteMessage) {
        if (!TextUtils.isEmpty(remoteMessage.getTo())) {
            ...
            intent.putExtra(BuildConfig.FLAVOR_base, PendingIntent.getBroadcast(applicationContext, 0, intent2, 0));
            intent.setPackage("com.google.android.gms");
            intent.putExtras(remoteMessage.zzdu);
