...
public class GooglePlayServicesUtilLight {
    ...
    public static boolean isRestrictedUserProfile(Context context) {
        if (PlatformVersion.isAtLeastJellyBeanMR2()) {
            Bundle applicationRestrictions = ((UserManager) context.getSystemService(PasswordLoginParams.IDENTIFIER_KEY_USER)).getApplicationRestrictions(context.getPackageName());
