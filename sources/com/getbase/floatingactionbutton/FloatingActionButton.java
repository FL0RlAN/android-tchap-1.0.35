...
public class FloatingActionButton extends ImageButton {
    ...
    public void init(Context context, AttributeSet attributeSet) {
        ...
        this.mColorNormal = obtainStyledAttributes.getColor(R.styleable.FloatingActionButton_fab_colorNormal, getColor(17170451));
        this.mColorPressed = obtainStyledAttributes.getColor(R.styleable.FloatingActionButton_fab_colorPressed, getColor(17170450));
        this.mColorDisabled = obtainStyledAttributes.getColor(R.styleable.FloatingActionButton_fab_colorDisabled, getColor(17170432));
    ...
    private Drawable createInnerStrokesDrawable(int i, float f) {
        ...
        paint.setStyle(Style.STROKE);
        final int i2 = i;
        AnonymousClass1 r2 = new ShaderFactory() {
