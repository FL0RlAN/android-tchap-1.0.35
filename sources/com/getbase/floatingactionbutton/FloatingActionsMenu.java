...
public class FloatingActionsMenu extends ViewGroup {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        this.mAddButtonPlusColor = obtainStyledAttributes.getColor(R.styleable.FloatingActionsMenu_fab_addButtonPlusIconColor, getColor(17170443));
        this.mAddButtonColorNormal = obtainStyledAttributes.getColor(R.styleable.FloatingActionsMenu_fab_addButtonColorNormal, getColor(17170451));
        this.mAddButtonColorPressed = obtainStyledAttributes.getColor(R.styleable.FloatingActionsMenu_fab_addButtonColorPressed, getColor(17170450));
    ...
    private void createAddButton(Context context) {
        this.mAddButton = new AddFloatingActionButton(context) {
            ...
            public Drawable getIconDrawable() {
                ...
                String str = "rotation";
                ObjectAnimator ofFloat = ObjectAnimator.ofFloat(rotatingDrawable, str, new float[]{FloatingActionsMenu.EXPANDED_PLUS_ROTATION, 0.0f});
                ObjectAnimator ofFloat2 = ObjectAnimator.ofFloat(rotatingDrawable, str, new float[]{0.0f, FloatingActionsMenu.EXPANDED_PLUS_ROTATION});
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (i9 == 0 || i9 == 1) {
            ...
            int i11 = this.mLabelsPosition == 0 ? (i3 - i) - (this.mMaxButtonWidth / 2) : this.mMaxButtonWidth / 2;
            int measuredWidth = i11 - (this.mAddButton.getMeasuredWidth() / 2);
            ...
            int i12 = (this.mMaxButtonWidth / 2) + this.mLabelsMargin;
            int i13 = this.mLabelsPosition == 0 ? i11 - i12 : i12 + i11;
            if (z2) {
                i5 = measuredHeight - this.mButtonSpacing;
            } else {
                i5 = this.mAddButton.getMeasuredHeight() + measuredHeight + this.mButtonSpacing;
            }
            int i14 = this.mButtonsCount - 1;
            while (i14 >= 0) {
                View childAt = getChildAt(i14);
                if (childAt == this.mAddButton || childAt.getVisibility() == i10) {
                    i6 = measuredHeight;
                } else {
                    int measuredWidth2 = i11 - (childAt.getMeasuredWidth() / 2);
                    if (z2) {
                        i5 -= childAt.getMeasuredHeight();
                    }
                    ...
                    if (view != null) {
                        if (this.mLabelsPosition == 0) {
                            i7 = i13 - view.getMeasuredWidth();
                        } else {
                            i7 = view.getMeasuredWidth() + i13;
                        }
                        int i15 = this.mLabelsPosition == 0 ? i7 : i13;
                        if (this.mLabelsPosition == 0) {
                            i7 = i13;
                        }
                        int measuredHeight2 = (i5 - this.mLabelsVerticalOffset) + ((childAt.getMeasuredHeight() - view.getMeasuredHeight()) / 2);
                        view.layout(i15, measuredHeight2, i7, measuredHeight2 + view.getMeasuredHeight());
                        this.mTouchDelegateGroup.addTouchDelegate(new TouchDelegate(new Rect(Math.min(measuredWidth2, i15), i5 - (this.mButtonSpacing / 2), Math.max(measuredWidth2 + childAt.getMeasuredWidth(), i7), childAt.getMeasuredHeight() + i5 + (this.mButtonSpacing / 2)), childAt));
            ...
            int i16 = i4 - i2;
            int i17 = this.mMaxButtonHeight;
            int measuredHeight3 = (i16 - i17) + ((i17 - this.mAddButton.getMeasuredHeight()) / 2);
