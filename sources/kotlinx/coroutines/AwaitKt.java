    ...
    public static final Object joinAll(Job[] jobArr, Continuation<? super Unit> continuation) {
        ...
        if (continuation instanceof AwaitKt$joinAll$1) {
            ...
            if ((awaitKt$joinAll$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i2 < i3) {
                    Job job3 = jobArr2[i2];
                    awaitKt$joinAll$1.L$0 = jobArr4;
                    awaitKt$joinAll$1.L$1 = jobArr3;
                    awaitKt$joinAll$1.L$2 = jobArr2;
                    awaitKt$joinAll$1.I$0 = i3;
                    awaitKt$joinAll$1.I$1 = i2;
                    awaitKt$joinAll$1.L$3 = job3;
                    awaitKt$joinAll$1.L$4 = job3;
                    awaitKt$joinAll$1.label = 1;
                    if (job3.join(awaitKt$joinAll$1) == obj) {
                        return obj;
                    }
                    i2++;
                    if (i2 < i3) {
