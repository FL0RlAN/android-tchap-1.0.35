...
public final class KTypeProjection {
    ...
    public static final class Companion {
        ...
        public final KTypeProjection invariant(KType kType) {
            Intrinsics.checkParameterIsNotNull(kType, PasswordLoginParams.IDENTIFIER_KEY_TYPE);
    ...
    public boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof KTypeProjection) {
                ...
                if (Intrinsics.areEqual((Object) this.variance, (Object) kTypeProjection.variance)) {
                }
            }
            return false;
        }
