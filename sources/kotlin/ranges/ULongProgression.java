...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    public int hashCode() {
        ...
        long j = this.first;
        int r1 = ((int) ULong.m157constructorimpl(j ^ ULong.m157constructorimpl(j >>> 32))) * 31;
        long j2 = this.last;
        int r12 = (r1 + ((int) ULong.m157constructorimpl(j2 ^ ULong.m157constructorimpl(j2 >>> 32)))) * 31;
        long j3 = this.step;
