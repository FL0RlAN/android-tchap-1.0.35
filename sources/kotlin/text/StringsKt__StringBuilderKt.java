...
class StringsKt__StringBuilderKt extends StringsKt__StringBuilderJVMKt {
    ...
    public static final <T extends Appendable> T append(T t, CharSequence... charSequenceArr) {
        ...
        Intrinsics.checkParameterIsNotNull(charSequenceArr, BingRule.ACTION_PARAMETER_VALUE);
    ...
    public static final StringBuilder append(StringBuilder sb, Object... objArr) {
        Intrinsics.checkParameterIsNotNull(sb, "$this$append");
        Intrinsics.checkParameterIsNotNull(objArr, BingRule.ACTION_PARAMETER_VALUE);
