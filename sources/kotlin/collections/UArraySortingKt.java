    ...
    private static final int m295partition4UcCI2c(byte[] bArr, int i, int i2) {
        ...
        while (i <= i2) {
            while (true) {
                ...
                if (Intrinsics.compare((int) UByteArray.m70getimpl(bArr, i) & UByte.MAX_VALUE, (int) b) >= 0) {
                    break;
                }
                i++;
            }
    ...
    private static final int m296partitionAa5vz7o(short[] sArr, int i, int i2) {
        ...
        while (i <= i2) {
            while (true) {
                ...
                if (Intrinsics.compare((int) UShortArray.m275getimpl(sArr, i) & UShort.MAX_VALUE, (int) s) >= 0) {
                    break;
                }
                i++;
            }
            ...
            if (i <= i2) {
                short s3 = UShortArray.m275getimpl(sArr, i);
                UShortArray.m280set01HTLdE(sArr, i, UShortArray.m275getimpl(sArr, i2));
                UShortArray.m280set01HTLdE(sArr, i2, s3);
                i++;
                i2--;
            }
        }
