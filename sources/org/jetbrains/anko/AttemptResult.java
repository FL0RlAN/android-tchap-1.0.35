...
public final class AttemptResult<T> {
    ...
    public static /* synthetic */ AttemptResult copy$default(AttemptResult attemptResult, T t, Throwable th, int i, Object obj) {
        if ((i & 1) != 0) {
    ...
    public boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof AttemptResult) {
                ...
                if (Intrinsics.areEqual((Object) this.value, (Object) attemptResult.value)) {
                }
            }
            return false;
        }
