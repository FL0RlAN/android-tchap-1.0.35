...
public final class AndroidAlertBuilder implements AlertBuilder<AlertDialog> {
    ...
    public void setTitle(CharSequence charSequence) {
        Intrinsics.checkParameterIsNotNull(charSequence, BingRule.ACTION_PARAMETER_VALUE);
    ...
    public void setIcon(Drawable drawable) {
        Intrinsics.checkParameterIsNotNull(drawable, BingRule.ACTION_PARAMETER_VALUE);
    ...
    public void setCustomTitle(View view) {
        Intrinsics.checkParameterIsNotNull(view, BingRule.ACTION_PARAMETER_VALUE);
