...
public final class SharedPreferencesKt {
    ...
    public static final void apply(SharedPreferences sharedPreferences, Function1<? super Editor, Unit> function1) {
    ...
    public static final void commit(SharedPreferences sharedPreferences, Function1<? super Editor, Unit> function1) {
        Intrinsics.checkParameterIsNotNull(sharedPreferences, "receiver$0");
        Intrinsics.checkParameterIsNotNull(function1, "modifier");
        Editor edit = sharedPreferences.edit();
        Intrinsics.checkExpressionValueIsNotNull(edit, "editor");
