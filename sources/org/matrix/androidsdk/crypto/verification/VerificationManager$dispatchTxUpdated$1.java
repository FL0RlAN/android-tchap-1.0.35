...
final class VerificationManager$dispatchTxUpdated$1 implements Runnable {
    final /* synthetic */ VerificationTransaction $tx;
    final /* synthetic */ VerificationManager this$0;

    VerificationManager$dispatchTxUpdated$1(VerificationManager verificationManager, VerificationTransaction verificationTransaction) {
        this.this$0 = verificationManager;
        this.$tx = verificationTransaction;
    }

    public final void run() {
        for (VerificationManagerListener transactionUpdated : this.this$0.listeners) {
            try {
                transactionUpdated.transactionUpdated(this.$tx);
            } catch (Throwable th) {
