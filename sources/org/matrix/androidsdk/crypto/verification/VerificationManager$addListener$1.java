...
final class VerificationManager$addListener$1 implements Runnable {
    final /* synthetic */ VerificationManagerListener $listener;
    final /* synthetic */ VerificationManager this$0;

    VerificationManager$addListener$1(VerificationManager verificationManager, VerificationManagerListener verificationManagerListener) {
        this.this$0 = verificationManager;
        this.$listener = verificationManagerListener;
    }

    public final void run() {
        if (!this.this$0.listeners.contains(this.$listener)) {
