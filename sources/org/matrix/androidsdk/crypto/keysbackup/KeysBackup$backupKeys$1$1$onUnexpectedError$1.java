...
final class KeysBackup$backupKeys$1$1$onUnexpectedError$1 implements Runnable {
    final /* synthetic */ Exception $e;
    final /* synthetic */ AnonymousClass1 this$0;

    KeysBackup$backupKeys$1$1$onUnexpectedError$1(AnonymousClass1 r1, Exception exc) {
        this.this$0 = r1;
        this.$e = exc;
    }
    ...
    public final void run() {
        ...
        if (access$getBackupAllGroupSessionsCallback$p != null) {
            access$getBackupAllGroupSessionsCallback$p.onUnexpectedError(this.$e);
        }
