...
final class RealmCryptoStore$getKeyBackupVersion$1 extends Lambda implements Function1<Realm, CryptoMetadataEntity> {
    public static final RealmCryptoStore$getKeyBackupVersion$1 INSTANCE = new RealmCryptoStore$getKeyBackupVersion$1();

    RealmCryptoStore$getKeyBackupVersion$1() {
        super(1);
    }
