...
final class RealmCryptoStore$storeDeviceId$1 extends Lambda implements Function1<Realm, Unit> {
    final /* synthetic */ String $deviceId;

    RealmCryptoStore$storeDeviceId$1(String str) {
        this.$deviceId = str;
        super(1);
    }
    ...
    public final void invoke(Realm realm) {
        ...
        if (cryptoMetadataEntity != null) {
            cryptoMetadataEntity.setDeviceId(this.$deviceId);
        }
    }
}
