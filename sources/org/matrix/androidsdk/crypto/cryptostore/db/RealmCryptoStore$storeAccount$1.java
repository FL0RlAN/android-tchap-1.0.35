...
final class RealmCryptoStore$storeAccount$1 extends Lambda implements Function1<Realm, Unit> {
    final /* synthetic */ OlmAccount $account;

    RealmCryptoStore$storeAccount$1(OlmAccount olmAccount) {
    ...
    public final void invoke(Realm realm) {
        ...
        if (cryptoMetadataEntity != null) {
            cryptoMetadataEntity.putOlmAccount(this.$account);
        }
    }
}
