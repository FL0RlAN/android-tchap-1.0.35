...
final class RealmCryptoStore$getAccount$1 extends Lambda implements Function1<Realm, CryptoMetadataEntity> {
    public static final RealmCryptoStore$getAccount$1 INSTANCE = new RealmCryptoStore$getAccount$1();

    RealmCryptoStore$getAccount$1() {
        super(1);
    }
