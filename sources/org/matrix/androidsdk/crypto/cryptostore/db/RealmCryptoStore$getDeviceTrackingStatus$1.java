...
final class RealmCryptoStore$getDeviceTrackingStatus$1 extends Lambda implements Function1<Realm, UserEntity> {
    final /* synthetic */ String $userId;

    RealmCryptoStore$getDeviceTrackingStatus$1(String str) {
        this.$userId = str;
        super(1);
    }
