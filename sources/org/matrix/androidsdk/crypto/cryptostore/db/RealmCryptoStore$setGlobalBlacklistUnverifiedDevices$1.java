...
final class RealmCryptoStore$setGlobalBlacklistUnverifiedDevices$1 extends Lambda implements Function1<Realm, Unit> {
    final /* synthetic */ boolean $block;

    RealmCryptoStore$setGlobalBlacklistUnverifiedDevices$1(boolean z) {
        this.$block = z;
        super(1);
    }
    ...
    public final void invoke(Realm realm) {
        ...
        if (cryptoMetadataEntity != null) {
            cryptoMetadataEntity.setGlobalBlacklistUnverifiedDevices(this.$block);
        }
    }
}
