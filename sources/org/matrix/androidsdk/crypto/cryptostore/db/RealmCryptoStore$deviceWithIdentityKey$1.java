...
final class RealmCryptoStore$deviceWithIdentityKey$1 extends Lambda implements Function1<Realm, DeviceInfoEntity> {
    final /* synthetic */ String $identityKey;

    RealmCryptoStore$deviceWithIdentityKey$1(String str) {
    ...
    public final DeviceInfoEntity invoke(Realm realm) {
        ...
        return (DeviceInfoEntity) where.equalTo(DeviceInfoEntityFields.IDENTITY_KEY, this.$identityKey).findFirst();
    }
}
