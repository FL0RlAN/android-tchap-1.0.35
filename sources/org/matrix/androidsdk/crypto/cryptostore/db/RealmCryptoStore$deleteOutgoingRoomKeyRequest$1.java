...
final class RealmCryptoStore$deleteOutgoingRoomKeyRequest$1 extends Lambda implements Function1<Realm, Unit> {
    final /* synthetic */ String $transactionId;

    RealmCryptoStore$deleteOutgoingRoomKeyRequest$1(String str) {
    ...
    public final void invoke(Realm realm) {
        ...
        OutgoingRoomKeyRequestEntity outgoingRoomKeyRequestEntity = (OutgoingRoomKeyRequestEntity) where.equalTo("requestId", this.$transactionId).findFirst();
