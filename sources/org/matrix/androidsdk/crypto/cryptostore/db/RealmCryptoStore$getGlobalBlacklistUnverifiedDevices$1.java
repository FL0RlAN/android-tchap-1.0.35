...
final class RealmCryptoStore$getGlobalBlacklistUnverifiedDevices$1 extends Lambda implements Function1<Realm, CryptoMetadataEntity> {
    public static final RealmCryptoStore$getGlobalBlacklistUnverifiedDevices$1 INSTANCE = new RealmCryptoStore$getGlobalBlacklistUnverifiedDevices$1();

    RealmCryptoStore$getGlobalBlacklistUnverifiedDevices$1() {
        super(1);
    }
