...
public class GroupsManager {
    ...
    public static final String LOG_TAG = GroupsManager.class.getSimpleName();
    /* access modifiers changed from: private */
    ...
    public void onJoinGroup(final String str, final boolean z) {
        ...
        String str2 = "join";
        if (TextUtils.equals(str2, group.getMembership())) {
            String str3 = LOG_TAG;
    ...
    public void getUserPublicisedGroups(final String str, boolean z, final ApiCallback<Set<String>> apiCallback) {
        String str2 = LOG_TAG;
        StringBuilder sb = new StringBuilder();
        String str3 = "## getUserPublicisedGroups() : ";
        sb.append(str3);
        sb.append(str);
    ...
    public void updateGroupPublicity(String str, boolean z, ApiCallback<Void> apiCallback) {
        ...
        AnonymousClass16 r1 = new SimpleApiCallback<Void>(apiCallback) {
            public void onSuccess(Void voidR) {
